...
export default function Login({ navigation }) {
  ...
  const handlelogin = async () => {
    try {
      ...
      setIsLogin(true)
      const response = await axios.post('https://api.kontenbase.com/query/api/v1/992ba35f-988f-4589-9657-74c80d2f014e/auth/login', body, config)
  ...
  return (
    <View style={{ justifyContent: "center",alignItems: "center"}}>
      ...
      <View>
        ...
        <Text style={{marginTop: 20,marginBottom:20, textAlign: "center"}}>New Users ? <Text onPress={() => navigation.navigate("Register")} style={{color: "#FF5555", fontWeight: 800}}>Register</Text></Text>
      </View>
    </View>
  );
}
